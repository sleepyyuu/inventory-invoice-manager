      ...
      <Routes>
        ...
        <Route element={<PersistAuth></PersistAuth>}>
          <Route element={<RequireAuth></RequireAuth>}>
            <Route path="/dashboard" element={<Dashboard selectedCategory={selectedCategory}></Dashboard>}>
              <Route path="/dashboard" exact element={<Summary selectedCategory={selectedCategory}></Summary>}></Route>
              ...
              <Route path="/dashboard/invoices/:invoiceId" element={InvoiceDetail}></Route>
            </Route>
          </Route>
        </Route>
