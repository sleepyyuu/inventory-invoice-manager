...
export default function Invoices(props) {
  ...
  const [newInvoiceBuyerAddress, setNewInvoiceBuyerAddress] = useState({});
  ...
  const handlePostAction = async (e) => {
    ...
    setNewInvoiceBuyerId(matchBuyer._id);
    setNewInvoiceBuyerAddress({ address: matchBuyer.address, city: matchBuyer.city, state: matchBuyer.state, zip: matchBuyer.zip });
    let body = {
