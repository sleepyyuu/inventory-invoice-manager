                                            ...
                                            >
                                              ...
                                              <div>
                                                ...
                                                <input
                                                  ...
                                                  onBlur={() => {
                                                    setnewInvoiceCurrentProductQuantityEdit(Number(newInvoiceCurrentProductQuantityEdit));
                                                  }}
                                                  onKeyPress={(e) => {
                                                    if (!/^[1-9]\d*(\.\d+)?$/.test(e.key)) {
                                                      e.preventDefault();
                                                    }
                                                  }}
                                              ...
                                              <div>
                                                ...
                                                <input
                                                  ...
                                                  onBlur={() => {
                                                    setNewInvoiceCurrentProductPriceEdit(Number(newInvoiceCurrentProductPriceEdit));
                                                  }}
                                                  onKeyPress={(e) => {
                                                    if (!/[0-9]/.test(e.key)) {
                                                      e.preventDefault();
                            ...
                            <div className="invoiceProductTableAddRow">
                              ...
                              <div>
                                ...
                                <input
                                  ...
                                  onBlur={(e) => {
                                    setnewInvoiceCurrentProductQuantity(Number(newInvoiceCurrentProductQuantity));
                                  }}
                                  onKeyPress={(e) => {
                                    if (!/[0-9]/.test(e.key)) {
                                      e.preventDefault();
                              ...
                              <div>
                                ...
                                <input
                                  ...
                                  onBlur={(e) => {
                                    setNewInvoiceCurrentProductPrice(Number(newInvoiceCurrentProductPrice));
                                  }}
                                  onKeyPress={(e) => {
                                    if (!/[0-9]/.test(e.key)) {
                                      e.preventDefault();
                              ...
                              <div>{"$" + newInvoiceCurrentProductQuantity * newInvoiceCurrentProductPrice}</div>
