  ...
  const handleEdit = async (invoice) => {
    ...
    setEditInvoiceQuantityMax(
      products.map((prod) => {
        ...
        prod.quantity = prod.quantity + invoiceQuantity;
        return prod;
      })
    );
    setShowMenu(true);
                              ...
                              {newInvoiceProducts.length === 0 ? (
                                ...
                                <div className="invoiceProductTableBody">
                                  {newInvoiceProducts.map((product, index) => {
                                    console.log(editInvoiceQuantityMax);
                                    return (
                                      <div key={index}>
                                        <div>
                                            ...
                                            >
                                              ...
                                              <div className="invoiceQuantityEditContainer">
                                                ...
                                                <QuantityInput
                                                  ...
                                                  quantityStock={editInvoiceQuantityMax[newInvoiceCurrentProductEdit].quantity}
                                                ></QuantityInput>
                                              </div>
