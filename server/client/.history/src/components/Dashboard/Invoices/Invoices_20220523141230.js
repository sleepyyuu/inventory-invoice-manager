...
export default function Invoices() {
  ...
  const [newInvoiceCurrentProductPrice, setNewInvoiceCurrentProductPrice] = useState(9);
                  ...
                  <div>
                    ...
                    <button
                      onClick={() => {
                        ...
                        setNewInvoiceProducts([...newInvoiceProducts, products[newInvoiceCurrentProduct]]);
                      }}
                    >
                      add another product
                    </button>
