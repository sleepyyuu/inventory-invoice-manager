                                            ...
                                            >
                                              ...
                                              <div>
                                                ...
                                                <input
                                                  ...
                                                  onChange={(e) => {
                                                    if (e.target.valueAsNumber > products[newInvoiceCurrentProductEdit].quantity) {
                                                      setnewInvoiceCurrentProductQuantityEdit(
                                                        products[newInvoiceCurrentProductEdit].quantity
                                                      );
                                                    } else {
                                                      setnewInvoiceCurrentProductQuantityEdit(e.target.valueAsNumber);
                                                    }
                                                  }}
                                                  onBlur={() => {
                                                    setnewInvoiceCurrentProductQuantityEdit(
                            ...
                            <div className="invoiceProductTableAddRow">
                              ...
                              <div>
                                ...
                                <input
                                  ...
                                  onBlur={(e) => {
                                    let decimalFixedQuantity = Number(e.target.valueAsNumber).toFixed(1);
                              ...
                              <div>
                                ...
                                <input
                                  ...
                                  onBlur={(e) => {
                                    let decimalFixed = Number(e.target.valueAsNumber).toFixed(2);
