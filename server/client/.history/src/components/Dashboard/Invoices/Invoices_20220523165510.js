...
export default function Invoices() {
  ...
  const [productsLeft, setProductsLeft] = useState([...products]);
                ...
                <div>
                  ...
                  {0 === productsLeft.length ? (
                    ...
                    <div>
                      ...
                      >
                        {productsLeft.map((prod, index) => {
                          return (
                            <option value={prod.name} key={uniqid()}>
                              {prod.name}
                            </option>
                          );
                        })}
                      ...
                      <button
                        onClick={(e) => {
                          ...
                          setProductsLeft(() => {
                            return products.filter((temp) => {
                              return temp.name !== newProductObject.name;
                            });
                          });
                        }}
                      >
