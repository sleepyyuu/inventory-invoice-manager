                      ...
                      <button
                        onClick={(e) => {
                          ...
                          for (let i = 0; i < products.length; i++) {
                            let isUsed = false;
                            for (let j of newInvoiceProducts) {
                              if (products[i].name === j.name || newProductObject.name === j.name) {
                                isUsed = true;
                                break;
                              }
                            }
                            if (isUsed) {
                              ...
                              return setNewInvoiceCurrentProduct(i);
                            }
                          }
                          return setNewInvoiceCurrentProduct(products.length + 1);
                        }}
                      >
                        add another product
                      </button>
