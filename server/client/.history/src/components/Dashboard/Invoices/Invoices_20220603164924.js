  ...
  const handlePostAction = async (e) => {
    ...
    if (menuStateCreate) {
      ...
      for (let product of newInvoiceProducts) {
        ...
        await verify("update", "/products/" + product.product, productBody);
      }
    } else {
      ...
      for (let product of newInvoiceProducts) {
        ...
        console.log(currentProduct.quantity + quantityDifference);
        let productBody = {
          quantity: currentProduct.quantity + quantityDifference,
        };
        console.log(product._id ? product._id : product.product);
        await verify("update", "/products/" + product._id ? product._id : product.product, productBody);
      }
    }
                            ...
                            <div className="invoiceProductTableAddRow">
                              ...
                              <div>
                                ...
                                <QuantityInput
                                  ...
                                  quantityStock={editInvoiceQuantityMax[newInvoiceCurrentProduct].quantity}
                                ></QuantityInput>
                              </div>
                              <div>
