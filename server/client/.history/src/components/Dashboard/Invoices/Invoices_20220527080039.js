                            ...
                            <div className="invoiceProductTableAddRow">
                              ...
                              <div>
                                ...
                                <input
                                  ...
                                  onBlur={(e) => {
                                    setnewInvoiceCurrentProductQuantity(Number(newInvoiceCurrentProductQuantity.toFixed(1)));
                                  }}
                                  onKeyPress={(e) => {
                                    if (!/[0-9]/.test(e.key)) {
                                      e.preventDefault();
                              ...
                              <div>
                                ...
                                <input
                                  ...
                                  onBlur={(e) => {
                                    setNewInvoiceCurrentProductPrice(Number(newInvoiceCurrentProductPrice.toFixed(2)));
                                  }}
                                  onKeyPress={(e) => {
                                    if (!/[0-9]/.test(e.key)) {
                                      e.preventDefault();
