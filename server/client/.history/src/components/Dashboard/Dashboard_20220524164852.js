...
import { FaFileInvoiceDollar, FaHome, FaStore, FaProductHunt, FaSignOut } from "react-icons/fa";
  ...
  return auth.accessToken ? (
    <div className="dashboardPage">
      <div className="sidebarContainer">
        ...
        <FaSignOut id="logoutButton" className="sidebarIcon navButton" size={35} onClick={logout}></FaSignOut>
      </div>
