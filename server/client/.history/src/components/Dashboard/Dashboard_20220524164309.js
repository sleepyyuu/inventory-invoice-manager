  ...
  return auth.accessToken ? (
    <div className="dashboardPage">
      <div className="sidebarContainer">
        ...
        <NavLink to="/login/" exact="true" className="inactive navButton" id="navInvoicesButton">
          <HiOutlineLogout className="sidebarIcon navButton" size={30} onClick={logout}></HiOutlineLogout>
        </NavLink>
      </div>
