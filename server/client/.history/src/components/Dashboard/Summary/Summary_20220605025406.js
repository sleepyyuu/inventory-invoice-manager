        ...
        <div id="dashboardInfo">
          <div>
            ...
            <div id="timeframeButtonContainer">
              <div className={selectedMonthFrame === 6 ? "timeframeButton selectedtimeframeButton" : "timeframeButton"}>6 month</div>
              <div className={selectedMonthFrame === 6 ? "timeframeButton selectedtimeframeButton" : "timeframeButton"}>3 month</div>
              <div className={selectedMonthFrame === 6 ? "timeframeButton selectedtimeframeButton" : "timeframeButton"}>1 month</div>
            </div>
          </div>
