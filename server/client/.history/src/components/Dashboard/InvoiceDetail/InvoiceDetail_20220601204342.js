    ...
    <div id="invoice">
      ...
      <div id="invoiceMiscDetail">
        ...
        <div id="invoiceNumberContainer">
          <div id="invoiceNumberTitle">Invoice No</div>
          {(invoice.invoice_number + "").padStart(5, "0")}
        </div>
        <div id="invoiceDateContainer">Date{new Date(invoice.date_created).toLocaleDateString()}</div>
      </div>
    </div>
  );
}
